...
public:
    ...
    bool BendingModel(double wb, double wp, double warea, double wsim, int dim, double tol, double bndrange, int bendrank, int alg, bool IsStartEnd, bool );//alg=0:ruling intersection, alg=1:regression curve
